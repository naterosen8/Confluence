...
// The argument, and the reason to believe anything else here.
//
// This was briefly the front page, which was right about the priority and
// wrong about the audience. Opening on a thesis asks someone to care about
// epistemics before they have any reason to — and the person who most needs
// these numbers is the one about to put money on a chart pattern, who did not
// arrive wanting a lecture on measurement.
//
// So the front door asks what they are about to buy, and this page sits one
// click behind it — reached from exactly the moment it becomes relevant, which
// is when they notice the site has not told them whether to buy.
//
...
export default function Why() {
  useDocumentTitle('Why we won’t tell you what to buy')
  ...
  return (
    <div className="home">
      <section className="home-lede">
        <p className="home-eyebrow">Why this site will not tell you what to buy</p>
